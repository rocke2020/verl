...
MODEL_PATH=/data/models/Qwen/Qwen2.5-32B-Instruct
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/data/corpus/openai/gsm8k/train.parquet \
    data.val_files=/data/corpus/openai/gsm8k/test.parquet \
    ...
    trainer.total_epochs=1 $@ 2>&1 | tee examples/tuning/32b/${WANDB_PROJECT}.log
